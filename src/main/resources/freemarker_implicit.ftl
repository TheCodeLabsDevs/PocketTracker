...
[#-- @ftlvariable name="showFilterOptions" type="de.thecodelabs.pockettracker.show.model.ShowFilterOption[]" --]
...
[#-- @ftlvariable name="apiConfigurationTypes" type="de.thecodelabs.pockettracker.administration.apiconfiguration.model.APIType[]" --]
