<#macro head title>
    ...
    <head>
        ...
        <link href="<@s.url "/webjars/bootstrap/5.2.3/css/bootstrap.min.css"/>" rel="stylesheet"/>
        <link href="<@s.url "/webjars/font-awesome/6.3.0/css/all.min.css"/>" rel="stylesheet"/>
        <link href="<@s.url "/css/main.css"/>" rel="stylesheet">

        <script src="<@s.url "/webjars/bootstrap/5.2.3/js/bootstrap.bundle.min.js"/>"></script>
