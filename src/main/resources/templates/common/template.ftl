<#macro head title>
    ...
    <head>
        ...
        <link href="<@s.url "/webjars/bootstrap/css/bootstrap.min.css"/>" rel="stylesheet"/>
        <link href="<@s.url "/webjars/font-awesome/css/all.min.css"/>" rel="stylesheet"/>
        <link href="<@s.url "/css/main.css"/>" rel="stylesheet">

        <script src="<@s.url "/webjars/bootstrap/js/bootstrap.bundle.min.js"/>"></script>
